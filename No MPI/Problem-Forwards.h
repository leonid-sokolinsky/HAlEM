...
namespace PF {
	...
	void	BasisReplace(PT_vector_T v_nex, PT_vector_i_T basis_v_nex, double* lambda, bool* success);
	...
	void	MakeEquationsBasis(int* basis, int* meq_basis, double eps_inverse);
